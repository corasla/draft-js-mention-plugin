...
var MentionSuggestions = function (_Component) {
  ...
  function MentionSuggestions() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MentionSuggestions.__proto__ || Object.getPrototypeOf(MentionSuggestions)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      if (_this.refs.popover) {
        var _ret2 = function () {
          ...
          var newStyles = _this.props.positionSuggestions({
            ...
            props: _this.props,
            state: _this.state,
            popover: _this.refs.popoverHolder
          });
          Object.keys(newStyles).forEach(function (key) {
            if (key !== 'transform' && key !== 'transition') {
              _this.refs.popoverHolder.style[key] = newStyles[key];
            }
          });
          Object.keys(newStyles).forEach(function (key) {
            if (key === 'transform' || key === 'transition') {
    ...
    }, _this.resetFocusedOptionIndex = function () {
      _this.setState({
        focusedOptionIndex: -1
      });
    }, _this.scrollToOptionIndex = function () {
      if (!_this.state.isActive) {
        return;
      }
      // scroll to selected option
      var diff = (_this.state.focusedOptionIndex - 2) * 28;
      var div = _reactDom2.default.findDOMNode(_this.refs.popover);
      ...
      _this.onMentionFocus(newIndex >= _this.props.suggestions.size ? -1 : newIndex);
      _this.scrollToOptionIndex();
      ...
      if (_this.props.suggestions.size >= 0) {
        var newIndex = _this.state.focusedOptionIndex - 1;
        _this.onMentionFocus(newIndex < -1 ? _this.props.suggestions.size - 1 : newIndex);
        _this.scrollToOptionIndex();
      }
      ...
      if (_this.props.onMentionSelect) {
        _this.props.onMentionSelect(mention);
      }
      ...
      if (_this.state.focusedOptionIndex === -1) {
        // create tag button
        _this.createButtonClicked();
      } else {
        _this.onMentionSelect(_this.props.suggestions.get(_this.state.focusedOptionIndex));
      }

      return true;
    }, _this.keyBindingFn = function (keyboardEvent) {
      ...
      _this.props.callbacks.keyBindingFn = _this.keyBindingFn;
    ...
    }, _this.createButtonClicked = function () {
      if (_this.props.onCreateMentionRequested) {
        _this.props.onCreateMentionRequested(_this.lastSearchValue);

        var fakeMentionsMap = (0, _immutable.fromJS)([{
          text: _this.lastSearchValue,
          name: _this.lastSearchValue }]);

        var newMention = fakeMentionsMap.get(0);
        _this.onMentionSelect(newMention);
      }
  ...
  _createClass(MentionSuggestions, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_CreateButton2.default, {
